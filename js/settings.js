...
function getAboutHtml() {
  return '<h3 style="margin:0 0 16px;font-size:16px;color:#fff;">关于 FakeOS</h3>'
    ...
    + '<div style="display:flex;justify-content:space-between;"><span>版本：</span><span style="color:#fff;cursor:pointer;" id="version-number" onclick="onVersionClick()">FakeOS v0.3.0</span></div>'
